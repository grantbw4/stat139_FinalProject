...
plot(gender_baseline, which=1:5, pch=1:5, xlab='logit', main=' ', xlim=range(gender_baseline[,3:6]))
...
plot(s_gender_race, which=1:5, pch=1:5, xlab='logit', main=' ', xlim=range(s_gender_race[,3:6]))
