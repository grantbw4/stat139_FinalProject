...
# Bar Plot: Gender Distribution Across Political Parties
ggplot(data_smol, aes(x = pid7, fill = gender4)) +
  geom_bar(position = "stack", stat = "count") +
  labs(title = "Gender Distribution Across Political Parties",
       x = "Political Party",
       y = "Count") +
